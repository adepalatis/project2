...
static bool setup_stack (const char* cmd, void **esp);
              ...
              uint32_t read_bytes, uint32_t zero_bytes, bool writable) 
{
  ...
  spte->num_pages = read_bytes / PGSIZE;
...
/* Create a minimal stack by mapping a zeroed page at the top of
   user virtual memory. */
static bool
setup_stack (const char* cmd, void **esp)
{
	uint8_t *kpage;
	bool success = false;
...
bool
install_page_public (void *upage, void *kpage, bool writable)
{
